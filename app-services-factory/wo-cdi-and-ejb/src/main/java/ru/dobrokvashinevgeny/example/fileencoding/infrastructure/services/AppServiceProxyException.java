 ...
 */
public class AppServiceProxyException extends Exception {
	/**
	 * Создает <code>AppServiceProxyException</code> с указанным
	 * детализирующим сообщением.
	 *
	 * @param message детализирующее сообщение.
	 */
	public AppServiceProxyException(String message) {
		super(message);
	}
	 ...
	 */
	public AppServiceProxyException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 *              что причина несуществует или неизвестна.)
	 */
	public AppServiceProxyException(Throwable cause) {
		super(cause);
	}
}