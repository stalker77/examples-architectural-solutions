 ...
 * Класс SomeDao
 */
public class SomeDaoException extends Exception {
	/**
	 * Создает <code>SomeDaoException</code> с указанным
	 * детализирующим сообщением.
	 *
	 * @param message детализирующее сообщение.
	 */
	public SomeDaoException(String message) {
		super(message);
	}
	 ...
	 */
	public SomeDaoException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 *              что причина несуществует или неизвестна.)
	 */
	public SomeDaoException(Throwable cause) {
		super(cause);
	}
}